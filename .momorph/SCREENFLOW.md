...
- **Created**: 2026-05-07
- **Last Updated**: 2026-05-10 (Hệ thống giải `zFYDgyj_pD` shipped — 6 phases of [specs/zFYDgyj_pD-he-thong-giai/tasks.md](specs/zFYDgyj_pD-he-thong-giai/tasks.md) complete; live at `/awards` with auth-gated Server Component, scroll-tracking client nav, IntersectionObserver-driven active state, hash-deep-link support; Vitest 261/261, Playwright awards spec 19/19)
